...
namespace
    ...
    output_file
        ...
        dump( std::string const & name ) const
            ...
            *out <<
                "//Copyright (c) 2009-2011 Emil Dotchevski and Reverge Studios, Inc."NL
                NL
    ...
    header_mr_ma_sb( output_file & out, int r, int c, std::string const & name )
        ...
        out.stream()<<
            ...
            TAB3"m_traits<A>::rows=="<<r<<" && m_traits<A>::cols=="<<c<<","NL
            TAB3"deduce_m<A> >::type"NL
            TAB2<<name<<"( A const & a, typename m_traits<A>::scalar_type b )"NL
            ;
        }
    ...
    header_vr_va_sb( output_file & out, int d, std::string const & name )
        ...
        out.stream()<<
            ...
            TAB3"v_traits<A>::dim=="<<d<<","NL
            TAB3"deduce_v<A> >::type"NL
            TAB2<<name<<"( A const & a, typename v_traits<A>::scalar_type b )"NL
            ;
        }
    ...
    header_ma_sb( output_file & out, int r, int c, std::string const & name )
        ...
        out.stream()<<
            ...
            TAB3"m_traits<A>::rows=="<<r<<" && m_traits<A>::cols=="<<c<<","NL
            TAB3"A &>::type"NL
            TAB2<<name<<"( A & a, typename m_traits<A>::scalar_type b )"NL
            ;
        }
    ...
    header_va_sb( output_file & out, int d, std::string const & name )
        ...
        out.stream()<<
            ...
            TAB3"v_traits<A>::dim=="<<d<<","NL
            TAB3"A &>::type"NL
            TAB2<<name<<"( A & a, typename v_traits<A>::scalar_type b )"NL
            ;
        }
    ...
    inverse_ma( output_file & out, int d, char const * suffix )
        ...
        g<<
            ...
            TAB3"deduce_m<A> >::type"NL
            TAB2"inverse( A const & a, typename m_traits<A>::scalar_type det )"NL
            TAB3"{"NL
            TAB3"typedef typename m_traits<A>::scalar_type T;"NL
            TAB3"BOOST_QVM_ASSERT(det!=s_traits<T>::value(0));"NL
            ;
        for( int i=0; i!=d; ++i )
            for( int j=0; j!=d; ++j )
                g<<TAB3"T const a"<<i<<j<<"=m_traits<A>::template r<"<<i<<','<<j<<">(a);"NL;
